...
async function compileScss() {
  ...
  const docScssFile = resolve(__dirname, 'site/stylesheets/doc.scss');
  const docCssFile = resolve(__dirname, 'site/stylesheets/doc.css');
  ...
  try {
    ...
    console.log('✓ Compiled site/stylesheets/doc.scss → site/stylesheets/doc.css');
  } catch (error) {
        ...
        plugins: [
          ...
          },
          {
            ...
            configureServer() {
              ...
              // Watch both scss and site/stylesheets directories
              const scssDir = resolve(__dirname, 'scss');
              const siteScssDir = resolve(__dirname, 'site/stylesheets');
