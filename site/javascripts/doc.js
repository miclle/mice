...
(function () {
  ...
  (function ($) {
          ...
          this.$element.slideUp(
            (function (_this) {
              return function () {
                ...
                _this.$element
                  .removeClass('success info warning danger')
                  .addClass(_this.options.status);
    ...
    $.fn.message.defaults = {
      template:
        '<div class="message"><div class="inner"></div><span class="close">&times;</span></div>',
      message: null,
      placement: 'top',
      status: '',
      duration: null,
  ...
  (function ($) {
    ...
    Tooltip = (function () {
      ...
      Tooltip.prototype.enter = function (obj) {
        var self;
        self =
          obj instanceof this.constructor ? obj : $(obj.currentTarget).data('mice.' + this.type);
        if (!self) {
      ...
      Tooltip.prototype.fixTitle = function () {
        if (
          ...
          typeof this.$element.attr('data-original-title') !== 'string'
        ) {
          return this.$element
            .attr('data-original-title', this.$element.attr('title') || '')
            .removeAttr('title');
        }
      };
      ...
      Tooltip.prototype.tip = function () {
        return (this.$tip =
          this.$tip || $(this.options.template).addClass(this.options.contextual));
      };
  ...
  Plugin.prototype = {
    init: function () {
      ...
      this.$suggOverlay = $("<span class='" + this.options.suggClass + "' />")
        ...
        .insertAfter(this.$field)
        .on('mousedown.eac touchstart.eac', $.proxy(this.autocomplete, this));
    },
