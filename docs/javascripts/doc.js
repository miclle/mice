...
(function() {
  ...
  (function($) {
    ...
    $.fn.emulateTransitionEnd = (function(_this) {
      return function(duration) {
        var called;
        called = false;
        $(_this).one("miceTransitionEnd", function() {
          return called = true;
        });
        setTimeout((function() {
          if (!called) {
            return $(_this).trigger($.support.transition.end);
          }
        }), duration);
        return _this;
      };
    ...
    return $(function() {
      ...
      return $.event.special.miceTransitionEnd = {
...
(function() {
  ...
  (function($) {
      ...
      function Modal(element, options) {
        ...
        if (this.options.remote) {
          this.$element.find('.modal-content').load(this.options.remote, $.proxy((function() {
            return this.$element.trigger('loaded.modal');
          }), this));
        }
      }
    ...
    Modal.prototype.show = function(_relatedTarget) {
      ...
      return this.backdrop((function(_this) {
        return function() {
          var transition;
          transition = $.support.transition && _this.$element.hasClass('fade');
          if (!_this.$element.parent().length) {
            _this.$element.appendTo(_this.$body);
          }
          _this.$element.show().scrollTop(0);
          if (transition) {
            _this.$element[0].offsetWidth;
          }
          _this.$element.addClass('in').attr('aria-hidden', false);
          _this.enforceFocus();
          e = $.Event('shown.modal', {
            relatedTarget: _relatedTarget
          });
          if (transition) {
            return _this.$element.find('.modal-dialog').one('miceTransitionEnd', function() {
              return this.$element.trigger('focus').trigger(e);
            }).emulateTransitionEnd(300);
          } else {
            return _this.$element.trigger('focus').trigger(e);
          }
        };
      })(this));
    };
    Modal.prototype.hide = function(e) {
      ...
      if ($.support.transition && this.$element.hasClass('fade')) {
        return this.$element.one('miceTransitionEnd', $.proxy(this.hideModal, this)).emulateTransitionEnd(300);
      } else {
        return this.hideModal();
      }
    };
    Modal.prototype.enforceFocus = function() {
      return $(document).off('focusin.modal').on('focusin.modal', $.proxy(function(e) {
    ...
    Modal.prototype.escape = function() {
      if (this.isShown && this.options.keyboard) {
        return this.$element.on('keyup.dismiss.modal', $.proxy(function(e) {
    ...
    Modal.prototype.hideModal = function() {
      ...
      return this.backdrop((function(_this) {
        return function() {
          return _this.$element.trigger('hidden.modal');
        };
      })(this));
    };
    ...
    Modal.prototype.backdrop = function(callback) {
      var animate, callbackRemove, doAnimate;
      ...
      if (this.isShown && this.options.backdrop) {
        ...
        if (doAnimate) {
          return this.$backdrop.one('miceTransitionEnd', callback).emulateTransitionEnd(150);
        } else {
          return callback();
        }
      } else if (!this.isShown && this.$backdrop) {
        this.$backdrop.removeClass('in');
        callbackRemove = (function(_this) {
          return function() {
        ...
        if ($.support.transition && this.$element.hasClass('fade')) {
          return this.$backdrop.one('miceTransitionEnd', callbackRemove).emulateTransitionEnd(150);
        } else {
    ...
    Modal.prototype.checkScrollbar = function() {
      ...
      return this.scrollbarWidth = this.scrollbarWidth || this.measureScrollbar();
    };
    Modal.prototype.setScrollbar = function() {
      var bodyPad;
      bodyPad = parseInt(this.$body.css('padding-right') || 0, 10);
      if (this.scrollbarWidth) {
        return this.$body.css('padding-right', bodyPad + this.scrollbarWidth);
      }
    };
    Modal.prototype.resetScrollbar = function() {
      return this.$body.css('padding-right', '');
    };
    ...
    Plugin = function(option, _relatedTarget) {
      return this.each(function() {
        ...
        if (!data) {
          $element.data('modal', (data = new Modal(this, options)));
        }
    ...
    $(document).on('click.modal.data-api', '[data-toggle="modal"]', function(e) {
      var $element, $target, href, option;
      $element = $(this);
      href = $element.attr('href');
      $target = $($element.attr('data-target') || (href && href.replace(/.*(?=#[^\s]+$)/, '')));
      ...
      $target.one('show.modal', function(showEvent) {
        ...
        return $target.one('hidden.modal', function() {
          return $element.is(':visible') && $element.trigger('focus');
        });
      });
  ...
  (function($) {
    ...
    Tooltip = (function() {
      ...
      Tooltip.prototype.init = function(type, element, options) {
        var eventIn, eventOut, trigger, _i, _len, _ref;
        this.enabled = true;
        this.type = type;
        this.$element = $(element);
        this.options = this.getOptions(options);
        this.$viewport = this.options.viewport && $(this.options.viewport.selector || this.options.viewport);
        _ref = this.options.trigger.split(' ');
      ...
      Tooltip.prototype.getDefault = function() {
        return $.fn.tooltip.defaults;
      };
      ...
      Tooltip.prototype.enter = function(obj) {
        var self;
        self = obj instanceof this.constructor ? obj : $(obj.currentTarget).data('mice.' + this.type);
        if (!self) {
          self = new this.constructor(obj.currentTarget, this.getDelegateOptions());
          $(obj.currentTarget).data('mice.' + this.type, self);
        }
      ...
      Tooltip.prototype.show = function() {
        var $parent, $tip, actualHeight, actualWidth, autoPlace, autoToken, calculatedOffset, complete, e, inDom, orgPlacement, parentDim, placement, pos;
        e = $.Event('show.mice.' + this.type);
        if (this.getTitle() && this.enabled) {
          this.$element.trigger(e);
          inDom = $.contains(document.documentElement, this.$element[0]);
          ...
          $tip.detach().css({
            ...
            left: 0,
            display: 'block'
          }).addClass(placement).data('mice.' + this.type, this);
          ...
          if (autoPlace) {
            ...
            placement = placement === 'bottom' && pos.top + pos.height + actualHeight - parentDim.scroll > parentDim.height ? 'top' : (placement === 'top' && pos.top - parentDim.scroll - actualHeight < 0 ? 'bottom' : void 0, placement === 'right' && pos.right + actualWidth > parentDim.width ? 'left' : void 0, placement === 'left' && pos.left - actualWidth < parentDim.left ? 'right' : placement);
          ...
          complete = (function(_this) {
            return function() {
              _this.$element.trigger('shown.mice.' + _this.type);
              return _this.hoverState = null;
            };
          })(this);
          if ($.support.transition && this.$tip.hasClass('fade')) {
            return $tip.one('miceTransitionEnd', complete).emulateTransitionEnd(150);
          } else {
            return complete();
          }
        }
      ...
      Tooltip.prototype.applyPlacement = function(offset, placement) {
        var $tip, actualHeight, actualWidth, arrowDelta, arrowOffsetPosition, arrowPosition, delta, height, marginLeft, marginTop, width;
        $tip = this.tip();
        width = $tip[0].offsetWidth;
        height = $tip[0].offsetHeight;
        marginTop = parseInt($tip.css('margin-top'), 10);
        marginLeft = parseInt($tip.css('margin-left'), 10);
        offset.top = offset.top + (isNaN(marginTop) ? 0 : marginTop);
        offset.left = offset.left + (isNaN(marginLeft) ? 0 : marginLeft);
        ...
        $tip.offset(offset);
        return this.replaceArrow(arrowDelta, $tip[0][arrowOffsetPosition], arrowPosition);
      };

      Tooltip.prototype.replaceArrow = function(delta, dimension, position) {
        return this.arrow().css(position, delta ? 50 * (1 - delta / dimension) + '%' : '');
      };

      Tooltip.prototype.setContent = function() {
        return this.tip().find('.inner')[this.options.html ? 'html' : 'text'](this.getTitle()).removeClass('fade in top bottom left right');
      };

      Tooltip.prototype.hide = function() {
        var $tip, complete, e;
        $tip = this.tip();
        e = $.Event('hide.mice.' + this.type);
        complete = (function(_this) {
          return function() {
            if (_this.hoverState !== 'in') {
              $tip.detach();
            }
            return _this.$element.trigger('hidden.mice.' + _this.type);
          };
        })(this);
        this.$element.trigger(e);
        if (e.isDefaultPrevented()) {
        ...
        $tip.removeClass('in');
        if ($.support.transition && this.$tip.hasClass('fade')) {
          $tip.one('miceTransitionEnd', complete).emulateTransitionEnd(150);
        } else {
          complete();
        }
      ...
      Tooltip.prototype.fixTitle = function() {
        if (this.$element.attr('title') || typeof (this.$element.attr('data-original-title')) !== 'string') {
          return this.$element.attr('data-original-title', this.$element.attr('title') || '').removeAttr('title');
        }
      };
      ...
      Tooltip.prototype.getViewportAdjustedDelta = function(placement, pos, actualWidth, actualHeight) {
        var bottomEdgeOffset, delta, leftEdgeOffset, rightEdgeOffset, topEdgeOffset, viewportDimensions, viewportPadding;
        delta = {
          top: 0,
          left: 0
        };
      ...
      Tooltip.prototype.getTitle = function() {
        return this.$element.attr('data-original-title') || (typeof this.options.title === 'function' ? this.options.title.call(this.$element[0]) : this.options.title);
      };

      Tooltip.prototype.tip = function() {
        return this.$tip = this.$tip || $(this.options.template).addClass(this.options.contextual);
      };
      ...
      Tooltip.prototype.toggle = function(e) {
        ...
        self = this;
        if (e) {
          self = $(e.currentTarget).data('mice.' + this.type);
          if (!self) {
            self = new this.constructor(e.currentTarget, this.getDelegateOptions());
            $(e.currentTarget).data('mice.' + this.type, self);
          }
        }
        if (self.tip().hasClass('in')) {
          return self.leave(self);
        } else {
      ...
      Tooltip.prototype.destroy = function() {
        clearTimeout(this.timeout);
        return this.hide().$element.off('.' + this.type).removeData('mice.' + this.type);
      };
    ...
    $.fn.tooltip = function(option) {
      return this.each(function() {
        ...
        if (!data) {
          $element.data('mice.tooltip', (data = new Tooltip(this, options)));
        }
        if (typeof option === 'string') {
          return data[option]();
        }
